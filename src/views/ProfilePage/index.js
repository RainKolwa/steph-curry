        ...
        <ul>
          ...
          <li>
            ...
            <input
              ...
              value={enname || ''}
              onChange={e => handleProfileChange({ enname: e.target.value })}
              placeholder="请填写"
            />
          </li>
          <li>
            ...
            <input
              ...
              value={!!birth ? birth : '2000-01-01'}
              onChange={e => handleProfileChange({ birth: e.target.value })}
            />
        ...
        <ul>
          ...
          {!address &&
            <li
              ...
              onTouchTap={() => this.handleEditAddress()}
            >
              <span>收件地址</span>
...
export default connect(state => {
  ...
  const { profile } = user || {}
  const { avatar, name, enname, birth, school, grade, email, address } =
    profile || {}
  return {
    name,
    enname,
